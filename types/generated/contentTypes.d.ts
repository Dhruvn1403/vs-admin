...
export interface ApiConsultationPackageConsultationPackage
  ...
  attributes: {
    ...
    fee_currency: Schema.Attribute.Enumeration<
      [
        '\u20B9 (Indian Rupee)',
        '$ (Dollar)',
        '\u20AC (Euro)',
    ...
    >;
    fee_in_number: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    payable_amount_currency: Schema.Attribute.Enumeration<
      [
        '\u20B9 (Indian Rupee)',
        '\u20AC (Euro)',
        '$ (Dollar)',
    ...
    >;
    payable_amount_in_number: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['paid', 'free']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
